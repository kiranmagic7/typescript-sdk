...
export class Server {
     ...
     * `capabilities` is shared by reference with {@linkcode legacy} via
    ...
    constructor(serverInfo: Implementation, options?: ServerOptions) {
        ...
        this.config = {
            serverInfo,
            capabilities: this._legacy.getCapabilities(),
    ...
    registerCapabilities(capabilities: ServerCapabilities): void {
        ...
        this.config.capabilities = this._legacy.getCapabilities();
    }
